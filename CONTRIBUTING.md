Contributing to MpcX Core
============================

The MpcX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MpcX Core project, and is not to be
confused with overall MpcX Network Protocol consensus changes.

Whether a pull request is merged into MpcX Core rests with the project merge
...
Patches that change MpcX consensus rules are considerably more involved than
...
Where a patch set proposes to change the MpcX consensus, it must have been
...
The project leader is the release manager for each MpcX Core release.
