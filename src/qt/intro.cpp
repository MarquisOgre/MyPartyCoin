...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MyPartyCoin Core"),
     ...
     * override -datadir in the mypartycoin.conf file in the default data directory
     * (to be consistent with mypartycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
