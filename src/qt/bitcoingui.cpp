                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MyPartyCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MyPartyCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mypartycoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MyPartyCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MyPartyCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MyPartyCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MyPartyCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MyPartyCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a MyPartyCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MyPartyCoin Core help message to get a list with possible MyPartyCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MyPartyCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MyPartyCoin network", "", count));
}
...
{
    QString strTitle = tr("MyPartyCoin Core"); // default title
