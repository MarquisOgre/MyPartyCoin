...
/** Utility functions used by the MyPartyCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MyPartyCoin addresses in monospace font
...
// Parse "mypartycoin:" URI into recipient object, return true on successful parsing
