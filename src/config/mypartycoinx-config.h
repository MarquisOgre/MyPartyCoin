/* src/config/mypartycoin-config.h.  Generated from mypartycoin-config.h.in by configure.  */
/* src/config/mypartycoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.mypartycoinexchange.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MyPartyCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MyPartyCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mypartycoin"
