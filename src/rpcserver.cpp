...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MyPartyCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MyPartyCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MyPartyCoin features */
        {"mypartycoin", "masternode", &masternode, true, true, false},
        {"mypartycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"mypartycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mypartycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mypartycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mypartycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"mypartycoin", "startmasternode", &startmasternode, true, true, false},
        {"mypartycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mypartycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mypartycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mypartycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mypartycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mypartycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mypartycoin", "mnbudget", &mnbudget, true, true, false},
        {"mypartycoin", "preparebudget", &preparebudget, true, true, false},
        {"mypartycoin", "submitbudget", &submitbudget, true, true, false},
        {"mypartycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mypartycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mypartycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mypartycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mypartycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mypartycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mypartycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mypartycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"mypartycoin", "mnsync", &mnsync, true, true, false},
        {"mypartycoin", "spork", &spork, true, true, false},
        {"mypartycoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mypartycoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mypartycoind, or the -server option to mypartycoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mypartycoin-cli " + methodname + " " + args + "\n";
}
