...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MyPartyCoin Core mypartycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mypartycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mypartycoin transaction") + "\n" +
                               "  mypartycoin-tx [options] -create [commands]   " + _("Create hex-encoded mypartycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mypartycoin transaction
