...
In order to support loading of multiple wallets in mypartycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mypartycoin.cpp.
...
Changes to mypartycoin.cpp
----------------------
mypartycoin.cpp is the entry point into mypartycoin-qt, and as such, will require some minor modifications to provide hooks for
