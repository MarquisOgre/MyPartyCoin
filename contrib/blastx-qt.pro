...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/mypartycoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/mypartycoin-cli.cpp \
           src/mypartycoin-tx.cpp \
           src/mypartycoin.cpp \
           src/db.cpp \
           ...
           src/qt/mypartycoin.cpp \
           src/qt/mypartycoinstrings.cpp \
...
RESOURCES += src/qt/mypartycoin.qrc src/qt/mypartycoin_locale.qrc

TRANSLATIONS += src/qt/locale/mypartycoin_bg.ts \
                src/qt/locale/mypartycoin_de.ts \
                src/qt/locale/mypartycoin_en.ts \
                src/qt/locale/mypartycoin_es.ts \
                src/qt/locale/mypartycoin_fi.ts \
                src/qt/locale/mypartycoin_fr.ts \
                src/qt/locale/mypartycoin_it.ts \
                src/qt/locale/mypartycoin_ja.ts \
                src/qt/locale/mypartycoin_pl.ts \
                src/qt/locale/mypartycoin_pt.ts \
                src/qt/locale/mypartycoin_ru.ts \
                src/qt/locale/mypartycoin_sk.ts \
                src/qt/locale/mypartycoin_sv.ts \
                src/qt/locale/mypartycoin_vi.ts \
                src/qt/locale/mypartycoin_zh_CN.ts \
                src/qt/locale/mypartycoin_zh_TW.ts
